...
<p class="fs-4">Selamat datang di kedai Fahri</p>
<p class="container col-10 text-white">Setiap gigitan adalah sebuah kenangan pedas yang takan terlupakan.Dapatkan sekarang hanya di kedai kami.</p>
...
<h2 class="text center mb-5">Kenapa harus cobain di kedai fahri </h2>
...
<div class="col-3">
    ...
    <div class="card">
   <img src="img/9.jpg" class="card-img-top" class="card-img-top" 	alt="...">
  <div class="card-body">
    <h5 class="card-title">Ayam geprek </h5>
    <p class="card-text">Cobalah Ayam geprek yang enak dan dan bikin goyang mulut.</p>
<div class="dropend">
...
<div class="col-3">
 ...
 <p class="card-text">Cobalah kentang goreng yang enak dan renyah di mulut.</p>
...
<div class="col-3">
    <div class="card">
   <img src="img/11.jpg" class="card-img-top" class="card-img-top" 	alt="...">
  <div class="card-body">
    <h5 class="card-title">Minuman dingin</h5>
    <p class="card-text">Cobalah minuman yang ada di menu kami.</p>
    <a href="#" class="btn btn-primary">Lihat</a>
  </div>
</div>
</div>
...
<div class="col-3">
   <div class="card">
   <img src="img/12.jpg" class="card-img-top" class="card-img-top" 	alt="...">
 

 <div class="card-body">
 
  <h5 class="card-title">Juice</h5>
    <p class="card-text">Cobalah juice yang segar dan bikin badan sehat.</p>
    <a href="#" class="btn btn-primary">Lihat</a>
  </div>
</div>
</div>
...
Customer yang beruntung minggu ini<a tabindex="0" data-bs-trigger="focus"  class="btn btn-secondary"  data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" title="informasi" data-bs-content="Pengundian di lakukan setiap jum'at jam 14.00">
  ?
</a>
